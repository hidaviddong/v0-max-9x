...
interface DataBridgeClientPageProps {
  initialData: Asset[]
  apiMessage: string
}
...
function DataBridgeClientPage({ initialData, apiMessage }: DataBridgeClientPageProps) {
  const { t } = useLanguage()
...
export { DataBridgeClientPage }
export default DataBridgeClientPage
