      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto text-pretty">
            MAX provides native data and components for users with seamless
            connectivity with external systems, users, and applications.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-gray-900 p-8 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 mb-4">
              Store, organize, and protect your video content with advanced
              metadata management and AI-powered tagging.
            </p>
          ...
          <div className="bg-gray-900 p-8 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 mb-4">
              Manage your visual content library with smart categorization and
          ...
          <div className="bg-gray-900 p-8 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 mb-4">
              Organize and protect your audio content with advanced
              fingerprinting and licensing tools.
            </p>
            <ul className="text-sm text-gray-300 space-y-2">
          ...
          <div className="bg-gray-900 p-8 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 mb-4">
              Secure document management with version control and collaborative
              editing features.
            </p>
            <ul className="text-sm text-gray-300 space-y-2">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                AI-powered tagging and categorization for effortless asset
                discovery.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Monitor and protect your assets across all major platforms
                worldwide.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Maximize monetization with intelligent licensing and
